...
export class ApiResponse<T = any> {
	 ...
	 */
	static paginated<T>(items: T[], currentPage: number, itemsPerPage: number, totalItems: number, message?: string): ApiResponse<PaginatedData<T>> {
	 ...
	 */
	static emptyPaginated<T>(currentPage: number = 1, itemsPerPage: number = 10, message?: string): ApiResponse<PaginatedData<T>> {
